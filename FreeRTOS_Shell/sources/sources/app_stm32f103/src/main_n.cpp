...
static const LcdConfig LCD1_CFG = {
    .i2cAddress = 0x27,
    .cols       = 16,
    .rows       = 2
};
...
static const LedConfig LED1_CFG = {
    .pin        = GPIO_LED_0,   // { GPIOC, GPIO13 } from GpioConfig.hpp
    .activeHigh = false         // Blue pill PC13 is active-low
};

// ── Active Object instances ────────────────────────────────────
static LcdAO lcdAO(LCD1_CFG);
