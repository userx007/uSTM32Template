...
// ============================================================================
// This approach works reliably in both hardware and Renode:
// - Uses blocking_read which is interrupt-driven
// - Yields briefly after each byte to allow other tasks to run
// - Simple and reliable - no DMA configuration needed
// ============================================================================
#[embassy_executor::task]
async fn uart_rx_task() {
    ...
    if let Some(mut rx) = rx {
        ...
        loop {
            // Use blocking_read in a loop with yields
            // This works reliably in Renode without DMA
            ...
            // This is important to keep the system responsive
